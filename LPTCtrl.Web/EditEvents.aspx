        ...
        <asp:GridView ID="EventsList" runat="server" Width="90%"
            ...
            <Columns>
                <asp:TemplateField ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Bottom">
                    ...
                    <ItemTemplate>
                        <asp:ImageButton ID="DeleteEventButton" runat="server" ImageUrl="~/Images/delete.png" AlternateText="Delete this event" CommandName="delete" />
                        &nbsp;
                        <asp:ImageButton ID="EditEventButton" runat="server" ImageUrl="~/Images/edit.png" AlternateText="Edit this event" CommandName="select" />
                    </ItemTemplate>
                </asp:TemplateField>
